...
void GenerateMerkleRoot_3_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void GenerateMerkleRoot_3_run(uint ctx_index,Circom_CalcWit* ctx);
Circom_TemplateFunction _functionTable[4] = { 
MiMCFeistel_0_run,
MiMCSponge_1_run,
Hash_2_run,
GenerateMerkleRoot_3_run };
...
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[0]); // line circom 326
while(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[1],&lvar[221],&circuitConstants[1]); // line circom 327
Fr_eq(&expaux[2],&lvar[221],&circuitConstants[437]); // line circom 327
Fr_lor(&expaux[0],&expaux[1],&expaux[2]); // line circom 327
...
PFrElement aux_dest = &lvar[220];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 330
// end load src
...
// load src
Fr_add(&expaux[0],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + 2]); // line circom 332
// end load src
...
PFrElement aux_dest = &lvar[219];
// load src
Fr_sub(&expaux[3],&lvar[221],&circuitConstants[3]); // line circom 332
Fr_add(&expaux[1],&signalValues[mySignalStart + 4],&signalValues[mySignalStart + ((1 * Fr_toInt(&expaux[3])) + 445)]); // line circom 332
Fr_add(&expaux[0],&expaux[1],&lvar[220]); // line circom 332
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
}
...
// load src
Fr_mul(&expaux[0],&lvar[219],&lvar[219]); // line circom 333
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 5)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 5)]); // line circom 334
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[437]); // line circom 335
if(Fr_isTrue(&expaux[0])){
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 336
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[222];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 336
// end load src
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 225)],&lvar[219]); // line circom 337
Fr_add(&expaux[0],&lvar[222],&expaux[2]); // line circom 337
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_eq(&expaux[0],&lvar[221],&circuitConstants[1]); // line circom 338
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[221])) + 664)];
// load src
Fr_sub(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 338
// end load src
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + 444],&lvar[219]); // line circom 340
Fr_add(&expaux[0],&signalValues[mySignalStart + 882],&expaux[2]); // line circom 340
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
PFrElement aux_dest = &lvar[221];
// load src
Fr_add(&expaux[0],&lvar[221],&circuitConstants[3]); // line circom 326
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[221],&circuitConstants[0]); // line circom 326
...
Fr_eq(&expaux[0],&lvar[3],&circuitConstants[1]); // line circom 67
if(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
Fr_add(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&signalValues[mySignalStart + 2]); // line circom 71
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
// run sub component if needed
...
ctx->componentMemory[coffset].templateName = "GenerateMerkleRoot";
ctx->componentMemory[coffset].signalStart = soffset;
...
Fr_lt(&expaux[0],&lvar[18],&circuitConstants[15]); // line circom 15
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[18];
// load src
Fr_add(&expaux[0],&lvar[18],&circuitConstants[3]); // line circom 15
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[18],&circuitConstants[15]); // line circom 15
...
Fr_lt(&expaux[0],&lvar[18],&circuitConstants[31]); // line circom 20
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &lvar[16];
// load src
Fr_add(&expaux[0],&lvar[16],&circuitConstants[3]); // line circom 22
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[18];
// load src
Fr_add(&expaux[0],&lvar[18],&circuitConstants[3]); // line circom 20
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_lt(&expaux[0],&lvar[18],&circuitConstants[31]); // line circom 20
...
Fr_gt(&expaux[0],&lvar[18],&circuitConstants[1]); // line circom 29
while(Fr_isTrue(&expaux[0])){
{
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
Fr_sub(&expaux[0],&lvar[18],&circuitConstants[3]); // line circom 30
// end load src
Fr_copy(aux_dest,&lvar[((1 * Fr_toInt(&expaux[0])) + 1)]);
}
// run sub component if needed
...
Fr_sub(&expaux[1],&lvar[18],&circuitConstants[5]); // line circom 32
Fr_div(&expaux[0],&expaux[1],&circuitConstants[5]); // line circom 32
{
...
PFrElement aux_dest = &lvar[17];
// load src
Fr_add(&expaux[0],&lvar[17],&circuitConstants[3]); // line circom 33
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &lvar[18];
// load src
Fr_sub(&expaux[0],&lvar[18],&circuitConstants[5]); // line circom 29
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
Fr_gt(&expaux[0],&lvar[18],&circuitConstants[1]); // line circom 29
...
GenerateMerkleRoot_3_create(1,0,ctx,"main",0);
GenerateMerkleRoot_3_run(0,ctx);
}
